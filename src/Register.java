...
public class Register extends JFrame implements ActionListener {
	...
	public Register() {
		...
		t1 = new JTextField();
		t1.setBounds(170, 30, 150, 40);
		super.add(t1);
		t2 = new JTextField();
		t2.setBounds(170, 130, 150, 40);
		super.add(t2);
		t3 = new JTextField();
		t3.setBounds(170, 230, 150, 40);
		super.add(t3);
		t4 = new JTextField();
		t4.setBounds(170, 330, 150, 40);
		super.add(t4);
		t5 = new JTextField();
		t5.setBounds(170, 430, 150, 40);
		super.add(t5);

		b = new JButton("Submit");
		b.setBounds(100, 550, 100, 40);
		super.add(b);
